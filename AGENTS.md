...
**Estado**: Fase 0 (bootstrap), item 012 de 016 concluído (harness 12/12 verde). Ferramentas ativas: ruff 0.16.5 + mypy 2.3.1 strict + pip-audit 2.10.1/Trivy 0.74.0 + Lefthook 2.1.12 + CI completo + `packages/core` + `packages/cli` (`fkx --help/--version`); `automação de release` (013) é o próximo.
